  ...
  return (
    <motion.div initial={{ y: 10, opacity: 0 }}
      ...
      {pants.length ?
        ...
        :
        <div className='text-center h-screen mx-auto w-96'>
      ...
      <div>{pants.length ? user?.isAdmin ? <button className='border-4 border-black block text-center mx-auto px-2 py-1 rounded-xl my-5' onClick={deleteAllProudcts}>delete all products</button> : null : null}</div>
    </motion.div>
  )
}
