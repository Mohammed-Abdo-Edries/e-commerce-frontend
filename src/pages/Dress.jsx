...
const Dress = () => {
  ...
  return (
    <>
      ...
      <div>{dress.length ? user?.isAdmin ? <button className='border-4 border-black px-2 py-1 rounded-xl my-5' onClick={deleteAllProudcts}>delete all products</button> : null : null}</div>
    </>
  )
}
